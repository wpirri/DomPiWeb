...
SELECT "INSERT INTO TB_DOM_USER(Id,Usuario,Nombre_Completo,Pin_Teclado,Pin_SMS,Pin_WEB,Telefono_Voz,Telefono_SMS,Usuario_Cloud,Clave_Cloud,Amazon_key,Google_Key,Apple_Key,Other_Key,Tarjeta,Acceso_Fisico,Acceso_Web,Acceso_Clowd,Dias_Semana,Hora_Desde,Minuto_Desde,Hora_Hasta,Minuto_Hasta,Estado,Contador_Error,Ultimo_Acceso,Ultimo_Error,Flags) 
        VALUES (",Id,",'",Usuario,"','",Nombre_Completo,"','",Pin_Teclado,"','",Pin_SMS,"','",Pin_WEB,"','",Telefono_Voz,"','",Telefono_SMS,"','",Usuario_Cloud,"','",Clave_Cloud,"','",Tarjeta,"','",Amazon_key,"','",Google_Key,"','",Apple_Key,"','",Other_Key,"','",Acceso_Fisico,"','",Acceso_Web,"','",Acceso_Clowd,"','",Dias_Semana,"',",Hora_Desde,",",Minuto_Desde,",",Hora_Hasta,",",Minuto_Hasta,",",Estado,",",Contador_Error,",'",Ultimo_Acceso,"','",Ultimo_Error,"',",Flags,");" 
        FROM TB_DOM_USER;
...
SELECT "INSERT INTO TB_DOM_EVENT(Id,Evento,Objeto_Origen,Objeto_Destino,Grupo_Destino,Particion_Destino,Variable_Destino,ON_a_OFF,OFF_a_ON,Enviar,Parametro_Evento,Condicion_Variable,Condicion_Igualdad,Condicion_Valor,Flags) 
        ...
        FROM TB_DOM_EVENT;
SELECT "INSERT INTO TB_DOM_AT(Id,Agenda,Mes,Dia,Hora,Minuto,Dias_Semana,Objeto_Destino,Grupo_Destino,Funcion_Destino,Evento,Parametro_Evento,Condicion_Variable,Condicion_Igualdad,Condicion_Valor,Ultimo_Mes,Ultimo_Dia,Ultima_Hora,Ultimo_Minuto,Flags) 
        VALUES(",Id,",'",Agenda,"',",Mes,",",Dia,",",Hora,",",Minuto,",'",Dias_Semana,"',",Objeto_Destino,",",Grupo_Destino,",",Funcion_Destino,",",Evento,",",Parametro_Evento,",",Condicion_Variable,",",Condicion_Igualdad,",",Condicion_Valor,",",Ultimo_Mes,",",Ultimo_Dia,",",Ultima_Hora,",",Ultimo_Minuto,",",Flags,");" 
        FROM TB_DOM_AT;
