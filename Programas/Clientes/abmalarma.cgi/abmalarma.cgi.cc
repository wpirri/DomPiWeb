...
int main(int /*argc*/, char** /*argv*/, char** env)
{
  ...
  if( pConfig->GetParam("TRACE-ABMALARMA.CGI", s))
  {
    trace = atoi(s);
  }
  ...
  if(trace)
  {
    openlog("abmalarma.cgi", 0, LOG_USER);
  ...
  else if( !strcmp(funcion, "list_all_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_list_all");
  }
  else if( !strcmp(funcion, "get_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_get");
  }
  else if( !strcmp(funcion, "add_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_add");
  }
  else if( !strcmp(funcion, "update_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_update");
  }
  else if( !strcmp(funcion, "delete_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_delete");
  }
  else if( !strcmp(funcion, "status_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_status");
  }
  else if( !strcmp(funcion, "info_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_info");
  }
  else if( !strcmp(funcion, "on_total_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_on_total");
  }
  else if( !strcmp(funcion, "on_parcial_part"))
  {
    strcpy(funcion_call, "dompi_alarm_part_on_parcial");
  }
  else if( !strcmp(funcion, "off_part"))
  {
  ...
  {
    strcpy(funcion_call, "dompi_alarm_zona_list");
  }
  else if( !strcmp(funcion, "list_all_zona"))
  {
    strcpy(funcion_call, "dompi_alarm_zona_list_all");
  }
  else if( !strcmp(funcion, "get_zona"))
  {
    strcpy(funcion_call, "dompi_alarm_zona_get");
  }
  else if( !strcmp(funcion, "add_zona"))
  {
    strcpy(funcion_call, "dompi_alarm_zona_add");
  }
  else if( !strcmp(funcion, "update_zona"))
  {
    strcpy(funcion_call, "dompi_alarm_zona_update");
  }
  else if( !strcmp(funcion, "delete_zona"))
  {
    strcpy(funcion_call, "dompi_alarm_zona_delete");
  }
  else if( !strcmp(funcion, "enable_zona"))
  {
    strcpy(funcion_call, "dompi_alarm_zona_enable");
  }
  else if( !strcmp(funcion, "disable_zona"))
  {
  ...
  {
    strcpy(funcion_call, "dompi_alarm_salida_list");
  }
  else if( !strcmp(funcion, "list_all_salida"))
  {
    strcpy(funcion_call, "dompi_alarm_salida_list_all");
  }
  else if( !strcmp(funcion, "get_salida"))
  {
    strcpy(funcion_call, "dompi_alarm_salida_get");
  }
  else if( !strcmp(funcion, "add_salida"))
  {
    strcpy(funcion_call, "dompi_alarm_salida_add");
  }
  else if( !strcmp(funcion, "update_salida"))
  {
    strcpy(funcion_call, "dompi_alarm_salida_update");
  }
