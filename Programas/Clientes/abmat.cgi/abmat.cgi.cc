...
int main(int /*argc*/, char** /*argv*/, char** env)
{
  ...
  if( pConfig->GetParam("TRACE-ABMAT.CGI", s))
  {
    trace = atoi(s);
  }
  ...
  {
    strcpy(funcion_call, "dompi_task_get");
  }
  else if( !strcmp(funcion, "add"))
  {
    strcpy(funcion_call, "dompi_task_add");
  }
  else if( !strcmp(funcion, "update"))
  {
    strcpy(funcion_call, "dompi_task_update");
  }
  else if( !strcmp(funcion, "delete"))
  {
    strcpy(funcion_call, "dompi_task_delete");
  }
  ...
  {
    strcpy(funcion_call, "dompi_task_list");
  }
