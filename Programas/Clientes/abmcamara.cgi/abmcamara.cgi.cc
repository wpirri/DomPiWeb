...
int main(int /*argc*/, char** /*argv*/, char** env)
{
  ...
  if( pConfig->GetParam("TRACE-ABMCAMARA.CGI", s))
  {
    trace = atoi(s);
  }
  ...
  {
    strcpy(funcion_call, "dompi_camara_get");
  }
  else if( !strcmp(funcion, "add"))
  {
    strcpy(funcion_call, "dompi_camara_add");
  }
  else if( !strcmp(funcion, "update"))
  {
    strcpy(funcion_call, "dompi_camara_update");
  }
  else if( !strcmp(funcion, "delete"))
  {
    strcpy(funcion_call, "dompi_camara_delete");
  }
  else if( !strcmp(funcion, "struct"))
  {
    strcpy(funcion_call, "dompi_db_struct");
  }
  else if( !strcmp(funcion, "all"))
  {
    strcpy(funcion_call, "dompi_camara_list_all");
  }
  else
  {
    strcpy(funcion_call, "dompi_camara_list");
  }
