...
int main(int /*argc*/, char** /*argv*/, char** env)
{
  ...
  if( pConfig->GetParam("TRACE-ABMMSGIR.CGI", s))
  {
    trace = atoi(s);
  }
  ...
  {
    strcpy(funcion_call, "dompi_msgir_get");
  }
  else if( !strcmp(funcion, "add"))
  {
    strcpy(funcion_call, "dompi_msgir_add");
  }
  else if( !strcmp(funcion, "update"))
  {
    strcpy(funcion_call, "dompi_msgir_update");
  }
  else if( !strcmp(funcion, "delete"))
  {
    strcpy(funcion_call, "dompi_msgir_delete");
  }
  ...
  {
    strcpy(funcion_call, "dompi_msgir_list");
  }
