...
<div id='analog_list_back_btn' class='back-btn' onclick="window.location.replace('<?php echo $AUTO_MENU?>');" >
	<img id='analog_list_back_icon' class='icon-btn' src='images/back.png'>&nbsp;Volver
</div>

<div id='analog_list_add_btn' class='add-btn' onclick="window.location.replace('analog_add.php');" >
