...
<div id='ass_list_back_btn' class='back-btn' onclick="window.location.replace('<?php echo $CONFIG_MENU?>');" >
	<img id='ass_list_back_icon' class='icon-btn' src='images/back.png'>&nbsp;Volver
</div>

<div id='ass_list_add_btn' class='add-btn' onclick="window.location.replace('ass_add.php');" >
...
<script type="text/javascript" >
    ...
    function LoadData(msg) {
        fillAssList(JSON.parse(msg).response, 'ass_list_table_div', '<?php echo $TITLE; ?>', 'Id', 'ass_edit.php', 'ass_delete.php');
    }
