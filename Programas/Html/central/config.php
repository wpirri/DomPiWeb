...
<div class="normal-btn" id="btn-config-net" onclick="window.location.replace('config.htm');">
	<img id="net-icon" class="icon-btn" src="/images/network.png">&nbsp;Red
</div>

<div class="normal-btn" id="btn-config-hard" onclick="window.location.replace('hard.htm');">
	<img id="disp-icon" class="icon-btn" src="/images/hard.png">&nbsp;Dispositivos
</div>


<div class="normal-btn" id="btn-config-groups" onclick="window.location.replace('group.htm');">
	<img id="group-icon" class="icon-btn" src="/images/group.png">&nbsp;Grupos
</div>

<div class="normal-btn" id="btn-config-events" onclick="window.location.replace('event.htm');">
	<img id="event-icon" class="icon-btn" src="/images/event.png">&nbsp;Eventos
</div>

<div class="normal-btn" id="btn-config-flags" onclick="window.location.replace('flag.htm');">
	<img id="alarm-icon" class="icon-btn" src="/images/var.png">&nbsp;Variables
</div>

<div class="normal-btn" id="btn-config-alarm" onclick="window.location.replace('alarm.htm?back=maincfg.htm');">
	<img id="alarm-icon" class="icon-btn" src="/images/lock1.png">&nbsp;Alarma
</div>

<div class="normal-btn" id="btn-config-cameras" onclick="window.location.replace('camera.htm');">
...
<div class="normal-btn" id="btn-config-upload" onclick="window.location.replace('upload.htm');">
	<img id="upload-icon" class="icon-btn" src="/images/upload.png">&nbsp;Actualizaci&oacute;n
</div>

<div class="normal-btn" id="btn-config-download" onclick="window.location.replace('download.htm');">
