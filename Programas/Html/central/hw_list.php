...
<div id='hw_list_back_btn' class='back-btn' onclick="window.location.replace('config.php');" >
...
<script type="text/javascript" >
    function LoadData(msg) {
        fillAbmList(JSON.parse(msg).response, 'hw_list_table_div', '<?php echo $TITLE; ?>', 'hw_id', 'hw_edit.php', 'hw_delete.php');
    }
