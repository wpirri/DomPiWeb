    ...
    function fillPartLongList(msg) { 
      try {
        ...
        if(document.getElementById('part-' + part.Nombre)) {
          ...
          if( part.Estado_Activacion == 0 ) {
            output += '<img id="Estado_Activacion" class="touch-icon" src="images/lock0.png" onclick="Click_Candado()" />';
          } else {
            output += '<img id="Estado_Activacion"  class="touch-icon" src="images/lock1.png" onclick="Click_Candado()" />';
          }
          ...
          for (i = 0; i < zonas.length; i++) {
            ...
            if( zonas[i].Activa == 0 ) {
              ...
              output += '<img id="zona-' + zonas[i].Objeto + '" src="images/led_rojo0.png" />';
            } else {
              output += '<img id="zona-' + zonas[i].Objeto + '" src="images/led_rojo1.png" />';
            }
            output += '</td> </tr>\n';
          }
          ...
          for (i = 0; i < salidas.length; i++) { 
            ...
            if( salidas[i].Estado == 0 ) {
              output += '<img id="salida-' + salidas[i].Objeto + '" src="images/sirena_mini0.png" />';
            } else {
              output += '<img id="salida-' + salidas[i].Objeto + '" src="images/sirena_mini1.png" />';
            }
            output += '</td> </tr>\n';
          }
